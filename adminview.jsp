<%-- 
    Document   : user
    Created on : May 19, 2018, 9:01:50 AM
    Author     : srinivasulu
--%>
...
<body>
  ...
  <a href="acustomerRegister.jsp"><i class="fa fa-registered"></i></a>
...
while (rs.next()) {
  ...
  <tr>
    ...
    <td><a href="aedit.jsp?id=<%=rs.getInt(1)%>"><img src="images/icons8-Edit-32.png" alt="Edit"></a>
    <a href="delCustomer.jsp?id=<%=rs.getInt(1)%>"><img src="images/icons8-Trash-32.png" alt="Delete"></a></td>
